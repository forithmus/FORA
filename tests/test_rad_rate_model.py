"""Tests for the RADRATE main model: initialization, forward pass, loss, inference."""
import pytest
import torch
import torch.nn.functional as F
import numpy as np
from unittest.mock import patch
from rad_rate import RADRATE, l2norm, cast_tuple, exists
...
# ---------------------------------------------------------------------------
# RADRATE model initialization tests
# ---------------------------------------------------------------------------
class TestRADRATEInit:
