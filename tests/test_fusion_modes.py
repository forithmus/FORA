...
class TestLateAttnFusion:
    ...
    def test_cross_attn_without_text_falls_back(self, image, vol_mask):
        ...
        model.eval()
        # Forward with text_input=None -> text_latents will be None -> fallback
        # We test _encode_visual_tokens directly with text_latents=None
